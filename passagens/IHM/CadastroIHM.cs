...
namespace passagens
{
    public partial class CadastroIHM : Form
    {
        ...
        private async void btnCadastrar_Click(object sender, EventArgs e)
        {
            ...
            cadastro.Senha = tbSenha.Text;

            Claim userRole = await CadastroBLL.validarCadastro(cadastro);
            if (Erro.GetErro())
            {
        ...
        private async void btnIrLogin_Click(object sender, EventArgs e)
        {
            LoginIHM loginForm = new LoginIHM();
            loginForm.Show();
            await Task.Delay(500);
            this.Hide();
        }
